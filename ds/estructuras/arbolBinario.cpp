template <class T>
ARBOL_BINARIO<T>::ARBOL_BINARIO(int limiteDatos) {
...
template <class T>
ARBOL_BINARIO<T>::~ARBOL_BINARIO(void) {};

template <class T>
void ARBOL_BINARIO<T>::push(T dato) {
...
template <class T>
nodoBinario<T>* ARBOL_BINARIO<T>::buscarRama(
...
template <class T>
bool ARBOL_BINARIO<T>::esHoja(nodoBinario<T>* punteroAux) {
...
template <class T>
T ARBOL_BINARIO<T>::pop(bool eliminar_mayor) {
    if(!this->estaVacia()) {
...
template <class T>
nodoBinario<T>* ARBOL_BINARIO<T>::buscarMenorElemento(
    nodoBinario<T>* punteroAux
) {
...
template <class T>
nodoBinario<T>* ARBOL_BINARIO<T>::buscarMayorElemento(
    nodoBinario<T>* punteroAux
) {
...
template <class T>
nodoBinario<T>* ARBOL_BINARIO<T>::getPunteroRaiz(void) {
