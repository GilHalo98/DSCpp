...
template <class T>
void LISTA<T>::push(T dato, int index) {
...
template <class T>
void LISTA<T>::intercambiarDatos(int indexA, int indexB) {
    // Interca mbia los datos entre nodos.

    // Delcaramos los punteros auxiliar a usar.
    nodoSimple<T>* punteroA = this->punteroInicio;
    nodoSimple<T>* punteroB = this->punteroInicio;
...
template <class T>
nodoSimple<T>* LISTA<T>::getPunteroInicio(void) {
    // Retorna el puntero inicio de la estructura.
    return this->punteroInicio;
};

template <class T>
nodoSimple<T>* LISTA<T>::getPunteroFin(void) {
    // Retorna el puntero fin de la estructura.
    return this->punteroFin;
};

template <class T>
nodoSimple<T>* LISTA<T>::getPunteroElemento(int indexAux) {
