...
template <class T>
ESTRUCTURA::LISTA_DOBLE<T>::LISTA_DOBLE(int limiteDatos) {
...
template <class T>
ESTRUCTURA::LISTA_DOBLE<T>::~LISTA_DOBLE(void) {};

template <class T>
void ESTRUCTURA::LISTA_DOBLE<T>::push(T dato, int index) {
...
template <class T>
T ESTRUCTURA::LISTA_DOBLE<T>::pop(int index) {
...
template <class T>
T ESTRUCTURA::LISTA_DOBLE<T>::operator [] (int index) {
...
template <class T>
void ESTRUCTURA::LISTA_DOBLE<T>::dump(void) {
...
template <class T>
nodoDoble<T> *ESTRUCTURA::LISTA_DOBLE<T>::getPunteroInicio(void) {
    return this->punteroInicio;
};

// Retorna el puntero fin de la estructura.
template <class T>
nodoDoble<T> *ESTRUCTURA::LISTA_DOBLE<T>::getPunteroFin(void) {
