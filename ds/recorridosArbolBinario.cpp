...
template <class T>
ESTRUCTURA::COLA<T> RECORRIDOS::recorridoArbolBinario(
    ESTRUCTURA::ARBOL_BINARIO<T> arbolBinario,
    ...
    ESTRUCTURA::COLA<T> colaRecorrido = ESTRUCTURA::COLA<T>(
...
void RECORRIDOS::preorden(
    ...
    ESTRUCTURA::COLA<T>* colaRecorrido
) {
